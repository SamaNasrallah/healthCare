            ...
            <li class="nav-item dropdown no-arrow mx-1">
                ...
                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="notificationsDropdown">
                    ...
                    @foreach($notifications as $notification)
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('patient.notifications') }}">
                            <div class="mr-3">
                            ...
                            @if(is_null($notification->read_at))
                                <form method="GET" action="{{ route('patient.notifications.read', $notification->id) }}" style="display: inline;">
                                    @csrf
                    ...
                    @endforeach
                    <a class="dropdown-item text-center small text-gray-500" href="{{ route('patient.notifications') }}">Show All Notifications</a>
                </div>
            </li>
        ...
        <div class="row mb-4">
            <div class="col-xl-12 col-md-12 mb-4">
                <div class="card shadow h-100 py-2">
                    <div class="card-body">
                        <h1 class="h3 mb-4 text-gray-800">Welcome, {{ \Illuminate\Support\Facades\Auth::user()->first_name }}!</h1>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card shadow h-100 py-2">
                    <div class="card-body">
                        ...
                        <a href="{{ route('patient.uploadDocuments') }}" class="btn btn-primary">Upload Documents</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card shadow h-100 py-2">
                    <div class="card-body">
                        ...
                        <a href="{{ route('patient.showMedicalRecords') }}" class="btn btn-warning">View Medical Records</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card shadow h-100 py-2">
                    <div class="card-body">
                        ...
                        <a href="{{ route('patient.doctors') }}" class="btn btn-info">View Doctors</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card shadow h-100 py-2" style="background-color: #ffffff;">
                    <div class="card-body">
                        ...
                        <a href="{{ route('patient.showAppointments') }}" class="btn btn-primary btn-sm mt-2">View Appointments</a>
                    </div>
                </div>
            </div>
        </div>
