...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('patient.showAppointments')}}">
        ...
        <!-- Nav Item - Doctors -->
        <li class="nav-item">
            <a class="nav-link" href="{{route('patient.doctors')}}">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('patient.uploadDocuments')}}">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('patient.showMedicalRecords')}}">
        ...
        <!-- Nav Item - Notifications -->
        <li class="nav-item">
            <a class="nav-link" href="{{route('patient.invoice.show')}}">
                <i class="fas fa-fw fa-bell"></i>
                <span>Invoices</span>
            </a>
        </li>
